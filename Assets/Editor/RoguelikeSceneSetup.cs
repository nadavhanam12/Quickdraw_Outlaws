...
public static class RoguelikeSceneSetup
{
    ...
    public static void SetupScene()
    {
        ...
        var mapFloorTMP = Txt(mapGO.transform, "FloorText", "Battle 1 / 8",
            18f, V2(0, 285), V2(500, 36), new Color(0.75f, 0.75f, 0.75f, 1f), TextAlignmentOptions.Center);

        // Map container — MapRenderer draws nodes + lines inside this
        var mapContainerGO = new GameObject("MapContainer", typeof(RectTransform));
        mapContainerGO.transform.SetParent(mapGO.transform, false);
        var mapContainerRT = (RectTransform)mapContainerGO.transform;
        mapContainerRT.anchorMin = mapContainerRT.anchorMax = new Vector2(0.5f, 0.5f);
        mapContainerRT.anchoredPosition = V2(0f, -8f);
        mapContainerRT.sizeDelta = V2(650f, 580f);
        ...
        SetF(mapRend, "mapContainer", mapContainerRT);
